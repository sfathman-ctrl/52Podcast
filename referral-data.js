/* =========================================================
   ...
   contactPhone blank ("") and that line just won't render.

   To add a new one: copy a block below, paste it above the
   "Add new products below this line" marker, edit the values.
   ========================================================= */
...
const PRODUCTS = [
  ...
  },
  {
    name: "Framing Buddy",
    tag: "Tools / DIY",
    description: "An ergonomic 16 inch on-center spacing tool that acts as a second hand for DIY builders framing walls.",
    url: "",
    cta: "Learn more →",
    contactName: "", contactRole: "", contactEmail: "", contactPhone: ""
  },
